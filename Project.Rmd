...
Falta añadir las networks del paper en el plot (cuando las tengamos todas).
...
Ejecutar los tres plots con colores. (falla el y_lim, añadirlo)
    ...
    for (vaccination_strategy in vaccination_strategies) {
        ...
        for (num_vaccinated in seq(4, 20, by = 4)) {
            for (alpha in alphas) {
               ...
               avg_prop_infected <- numeric(0)
               avg_num_infected <- numeric(0)
               ...
               for (sim_run in 1:5) {
                   ...
                   avg_prop_infected <- avg_prop_infected + res$prop_infected
                   avg_num_infected <- avg_num_infected + res$num_infected
               }

               # Average the results
               avg_prop_infected <- avg_prop_infected / 5
               avg_num_infected <- avg_num_infected / 5
...
for (network_idx in 1:length(networks)) {
    ...
    for (vaccination_strategy in vaccination_strategies) {
        ...
        for (num_vaccinated in c(4,8)) {
             ...
             out_filename = paste("sim2/c2_", network_name, "_", vaccination_strategy,"_",num_vaccinated,"fig4.csv", sep="")
